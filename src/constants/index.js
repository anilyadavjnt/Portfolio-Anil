...
const projects = [
  {
    name: "Black Bird OTT",
    description:
      "Welcome to Black Bird OTT, your ultimate entertainment destination! Stream a wide range of original web series, blockbuster movies, reality shows, TV content, and audiobooks – all in multiple Indian languages and all in one app.",
    tags: [
      {
        name: "iOS",
    ...
    image: project1,
    view: "https://apps.apple.com/in/app/black-bird-ott/id6745434988",
  },
  {
